...
if os.path.exists("NN_confusion.txt"):
	os.remove("NN_confusion.txt")
if os.path.exists("NN_accuracy.txt"):
	os.remove("NN_accuracy.txt")  
...
# Activation function        
    ...
    NN_search = HalvingGridSearchCV(MLPClassifier(), parameters, verbose = 3).fit(x_validation_data, y_validation_data)
    best_parameters = NN_search.best_params_
    print("Best parameters found for NN:", best_parameters)


    print("Creating NN model to be trained")
